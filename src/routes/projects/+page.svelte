<script>
  import ProjectListDesktop from "$lib/components/project_list_desktop.svelte";
...
<Section>
  ...
  <ProjectListMobile {projects} {openProject} />
  <ProjectListDesktop {projects} {openProject} {randomPerms} {randomDetails} />
</Section>
